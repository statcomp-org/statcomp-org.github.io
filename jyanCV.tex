...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{Students}
    ...
    \item Jun Jin, Ph.D. 2024 (joint with Kun Chen): On large-scale transfer learning with heterogeneous data. Placement: Faculty Biostatistician, Henry Ford Health.
